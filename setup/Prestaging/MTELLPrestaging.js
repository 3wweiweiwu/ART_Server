        ...
        return new Promise((resolve,reject)=>{
            ...
            taskSupport.PostTask(taskSupport.taskMediaDetection)
                ...
                .then(()=>{
                    ...
                    return new Promise((resolve)=>{
                        registrySupport.postRegistry(visionObj.name,registrySupport.Keys.Template,taskSupport.sampleDeployStandardVHDImage.name,'base_vhd_path','59f77f079ec86f2536006cda')
                            .then(()=>{
                ...
                .then(()=>{
                    ...
                    return new Promise((resolve)=>{
                        registrySupport.postRegistry(registrySupport.Keys.Template,blueprintMediaPreparationObj.name,taskSupport.sampleInstallMedia.name,'Installation_File','\\\\hqfiler\\upload$\\aspenONEV10.0\\APM\\V10.0_APM_Suite_174.iso')
                            ...
                            .then(()=>{
                                let Product_Verification=['Aspen Mtell Maintenance Connection EAM Adapter (64bit)','Aspen Mtell Infor EAM Adapter (64bit)','Aspen Mtell Tabware EAM Adapter (64bit)','Aspen Mtell Log Manager (64bit)','Aspen Mtell Agent Service (64bit)','Aspen Mtell Gateway Server (32bit)','Aspen Mtell Empac EAM Adapter (64bit)','Aspen Mtell Training Service (64bit)','Aspen Mtell Avantis EAM Adapter (64bit)','Aspen Mtell Aptitude Observer Sensor Adapter (64bit)','Aspen Mtell MP2 EAM Adapter (64bit)','Aspen Mtell IBM Maximo EAM Adapter (64bit)','Aspen Mtell Core Applications and Services (64bit)','Aspen Mtell Oracle JD Edwards EAM Adapter (64bit)','Aspen Mtell OSIsoft Pi Sensor Adapter (64bit)','Aspen Mtell HMI Maintenance Gateway (32bit)','Aspen Mtell OpenTSDB Sensor Adapter (64bit)','Aspen Mtell Honeywell PHD Sensor Adapter (64bit)','Aspen Mtell Cityworks EAM Adapter (64bit)','Aspen Mtell HMI Maintenance Gateway (64bit)','Aspen Mtell Hansen EAM Adapter (64bit)','Aspen Mtell Mainsaver EAM Adapter (64bit)'];
