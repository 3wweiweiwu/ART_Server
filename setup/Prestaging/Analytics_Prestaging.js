...
describe('Add new vision APM Prestaging',()=>{
    ...
    it('shall Add APM prestaging into the project',done=>{
        prestaging.configure(visionSupport.sample_Prestaging.Analytics,projectSupport.sample_AnalyticsCP.Media_Detection,mediaDetection.constant.analytics_cp,projectSupport.sample_AnalyticsCP.Prestaging,deployVHD.Constant.analyticsCP.prestaging,installMedia.Constant.Analytics_CP,vhdCheckin.Constant.analytics_aspenONEV10_0_3,dormSupport.MVF2,'mvt2-ana-01')
            .then(()=>{
                done();
            })
            .catch((err)=>{                                
