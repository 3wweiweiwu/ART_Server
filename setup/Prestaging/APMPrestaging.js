...
describe('Add new vision APM Prestaging',()=>{
    ...
    it('shall Add APM prestaging into the project',done=>{
        prestaging.configure(visionSupport.sampleAPMPrestaging,projectSupport.sample_APMMediaDetection,mediaDetection.constant.apm,projectSupport.sampleAPMPrestaging,deployVHD.Constant.apm.prestaging,installMedia.Constant.APM,vhdCheckin.Constant.apmv101,dormSupport.MVF1,'mvt2-apm-01')
            .then(()=>{
                done();
            })
            .catch((err)=>{                                
