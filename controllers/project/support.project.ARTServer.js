...
exports.sampleAPMDeployment={
    ...
    memory_usage_mb:6*1024,
    disk_usage_mb:10*1024,
    tasks:[taskSupport.sampleDeployStandardVHDImage.name,taskSupport.sampleUninstallProduct.name,taskSupport.sampleRestart,taskSupport.sampleWait,taskSupport.sampleInstallMedia.name,taskSupport.sampleRestart,taskSupport.sampleWait,taskSupport.sampleVHDCheckin],
    next:[]       
};
