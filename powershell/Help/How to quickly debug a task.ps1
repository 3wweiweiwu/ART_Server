#In the node side, add a new task into the database
#launch machine manager in the client side manually and change the debugpreference global variable to continue
#In the powershell side, schedule a new task to the client
